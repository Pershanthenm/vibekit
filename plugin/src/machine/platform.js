...
export function detectPlatform() {
  if (process.env.VIBEKIT_PLATFORM) return process.env.VIBEKIT_PLATFORM;
...
// VIBEKIT_TOOL_DIRS pins the list (empty for none), in the same family as VIBEKIT_PLATFORM.
const EXTRA_BIN_DIRS = () => {
  const pinned = process.env.VIBEKIT_TOOL_DIRS;
