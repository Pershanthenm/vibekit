...
domain: research
triggers: [research ops skills, design clinical study, what sample size, r&d budget, burn rate, capitalize or expense]
description: Use when planning, funding, scoping, or synthesizing enterprise research across workstreams — clinical study design, R&D program finance, market sizing/surveys, or product/user research.
source: alirezarezvani/claude-skills · research-ops/skills/research-ops-skills/SKILL.md @19392f7 · MIT
---
