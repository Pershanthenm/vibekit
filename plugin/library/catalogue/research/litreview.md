...
name: litreview
domain: research
triggers: [litreview, launching pad, litreview on topic, literature review topic, literature review x, writing paper x]
description: Academic literature orientation skill that searches papers via free keyless APIs (PubMed E-utilities + OpenAlex) by default — with the Consensus MCP as an optional enhancement lane when connected — builds a strategic search plan using PICO (default) or SPIDER…
source: alirezarezvani/claude-skills · research/litreview/skills/litreview/SKILL.md @19392f7 · MIT
---
