...
name: deep-research
domain: research
triggers: [deep research, expensive: strategy work, comparing n products/methods/markets, hypothesis external data, how field works]
description: Run a disciplined, multi-source research investigation for a high-stakes question or decision — fan-out web search across many channels, parallel sub-agents, source triangulation (each claim backed by ≥3 independent sources), an adversarial review pass, and…
source: alirezarezvani/claude-skills · research/deep-research/skills/deep-research/SKILL.md @19392f7 · MIT
---
