...
name: research
domain: research
triggers: [research, match more-specific e.g.,, look into topic, we know topic, investigate topic, me information topic]
description: Default entry point for any research request — a hybrid router that classifies the question deterministically and either delegates to a specialist research skill (pulse for trends/sentiment, grants for NIH funding, litreview for academic literature, syllabus…
source: alirezarezvani/claude-skills · research/research/skills/research/SKILL.md @19392f7 · MIT
---
