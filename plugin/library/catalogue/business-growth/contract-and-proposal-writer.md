...
triggers: [contract proposal writer, drafting freelance contract, preparing client proposal, sow new engagement, sharing sensitive material]
description: Generate professional, jurisdiction-aware business documents: freelance contracts, project proposals, SOWs, NDAs, and MSAs. Structured Markdown output with docx conversion instructions. Covers US (Delaware), EU (GDPR), UK, and DACH (German law) jurisdictions.
source: alirezarezvani/claude-skills · business-growth/skills/contract-and-proposal-writer/SKILL.md @19392f7 · MIT
---
