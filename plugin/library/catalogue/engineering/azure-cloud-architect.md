...
domain: engineering
triggers: [azure cloud architect, design azure infrastructure, create bicep/arm templates, optimize azure costs, azure devops pipelines, migrate to azure]
description: Design Azure architectures for startups and enterprises. Use when asked to design Azure infrastructure, create Bicep/ARM templates, optimize Azure costs, set up Azure DevOps pipelines, or migrate to Azure.
source: alirezarezvani/claude-skills · engineering-team/skills/azure-cloud-architect/SKILL.md @19392f7 · MIT
---
