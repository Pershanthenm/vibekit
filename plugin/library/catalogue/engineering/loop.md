...
name: loop
domain: engineering
triggers: [loop, runs /ar:loop, experiment continuously schedule]
...
source: alirezarezvani/claude-skills · engineering/autoresearch-agent/skills/loop/SKILL.md @19392f7 · MIT
---
