...
domain: engineering
triggers: [snowflake development, writing snowflake sql, pipelines dynamic tables, streams/tasks, cortex ai functions, creating cortex agents]
...
source: alirezarezvani/claude-skills · engineering-team/snowflake-development/skills/snowflake-development/SKILL.md @19392f7 · MIT
---
