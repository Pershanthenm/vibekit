...
domain: engineering
triggers: [migration architect, planning database migration, infrastructure cutover, system replacement, explicit rollback paths]
description: Zero-downtime migration planning, compatibility validation, and rollback strategy generation. Tools for system, database, and infrastructure migrations with minimal business impact.
