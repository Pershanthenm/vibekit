...
domain: engineering
triggers: [llm cost optimizer, costs too high, optimize token usage, model should i, spend out control, implement prompt caching]
description: Use proactively whenever LLM API costs come up -- or should. Triggers include: 'my AI costs are too high', 'optimize token usage', 'which model should I use', 'LLM spend is out of control', 'implement prompt caching', 'we're about to launch an AI feature',…
source: alirezarezvani/claude-skills · engineering/llm-cost-optimizer/skills/llm-cost-optimizer/SKILL.md @19392f7 · MIT
---
