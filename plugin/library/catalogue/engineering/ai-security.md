...
name: ai-security
domain: engineering
triggers: [ai security, systems prompt injection, jailbreak vulnerabilities, model inversion risk, data poisoning exposure, agent tool abuse]
...
source: alirezarezvani/claude-skills · engineering-team/skills/ai-security/SKILL.md @19392f7 · MIT
---
