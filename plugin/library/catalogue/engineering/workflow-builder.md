...
domain: engineering
triggers: [workflow builder, wants build, create, author, scaffold, run custom workflow]
description: Design and write deterministic multi-agent workflow scripts (.js files in .claude/workflows/) for Claude Code's Workflow tool.
source: alirezarezvani/claude-skills · engineering/workflow-builder/skills/workflow-builder/SKILL.md @19392f7 · MIT
---
