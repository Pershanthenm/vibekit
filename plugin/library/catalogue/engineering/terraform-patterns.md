...
domain: engineering
triggers: [terraform patterns, cli, cursor, openclaw, ci/cd plan/apply workflows]
description: Terraform infrastructure-as-code agent skill and plugin for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw.
source: alirezarezvani/claude-skills · engineering/terraform-patterns/skills/terraform-patterns/SKILL.md @19392f7 · MIT
---
