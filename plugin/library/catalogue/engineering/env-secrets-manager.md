...
domain: engineering
triggers: [env secrets manager, auditing, across local development, awareness, rotation readiness, use when auditing]
description: Manage environment-variable hygiene and secrets safety across local development and production. Practical auditing, drift awareness, rotation readiness.
