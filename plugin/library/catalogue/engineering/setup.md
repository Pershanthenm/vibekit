...
name: setup
domain: engineering
triggers: [setup, runs /ar:setup, file autoresearch loop]
...
source: alirezarezvani/claude-skills · engineering/autoresearch-agent/skills/setup/SKILL.md @19392f7 · MIT
---
