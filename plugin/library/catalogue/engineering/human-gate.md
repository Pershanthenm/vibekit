...
name: human-gate
domain: engineering
triggers: [human gate, get sign-off, have someone check, hold until reviewed, needs approval first, a plan]
description: Runs the human-verification lane of an agent loop, and proves review happened before work is called done.
source: alirezarezvani/claude-skills · engineering/human-gate/skills/human-gate/SKILL.md @19392f7 · MIT
---
