...
domain: engineering
triggers: [stripe integration expert, stripe first time, webhook reliability issues, different payment provider, existing subscription product]
description: Production-grade Stripe integrations: subscriptions with trials and proration, one-time payments, usage-based billing, checkout sessions, idempotent webhook handlers, customer portal, and invoicing. Covers Next.js, Express, and Django patterns.
source: alirezarezvani/claude-skills · engineering-team/skills/stripe-integration-expert/SKILL.md @19392f7 · MIT
---
