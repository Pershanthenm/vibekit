...
domain: engineering
triggers: [up deep rl, up deep rl\, rl fundamentals mdps, model-free algorithm taxonomy, policy gradient derivations, reference algorithms vpg]
description: Knowledge base from \"Spinning Up in Deep RL\" by Joshua Achiam (OpenAI, MIT-licensed).
source: alirezarezvani/claude-skills · engineering/spinning-up-deep-rl/skills/spinning-up-deep-rl/SKILL.md @19392f7 · MIT
---
