...
name: rag-architect
domain: engineering
triggers: [rag architect, system our docs, should i corpus, against ground truth, design rag pipeline, choose chunking strategy]
description: Use when the user asks to design a RAG pipeline, choose a chunking strategy or embedding model, pick a vector database, or evaluate retrieval quality (precision@k, recall@k, NDCG).
source: alirezarezvani/claude-skills · engineering/skills/rag-architect/SKILL.md @19392f7 · MIT
---
