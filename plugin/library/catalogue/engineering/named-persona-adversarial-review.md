...
domain: engineering
triggers: [persona adversarial review, findings feel generic, pr has architectural, ux impact, hardening beyond checks]
...
source: alirezarezvani/claude-skills · engineering-team/skills/named-persona-adversarial-review/SKILL.md @19392f7 · MIT
---
