...
name: hub-init
domain: engineering
triggers: [hub init, runs /hub:hub-init, multi-agent competition task]
...
source: alirezarezvani/claude-skills · engineering/agenthub/skills/hub-init/SKILL.md @19392f7 · MIT
---
