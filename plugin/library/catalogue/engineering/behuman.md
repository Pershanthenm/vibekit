...
name: behuman
domain: engineering
triggers: [behuman, be real, like a human, more human, less ai, talk like person]
description: Use when the user wants more human-like AI responses — less robotic, less listy, more authentic.
source: alirezarezvani/claude-skills · engineering/behuman/skills/behuman/SKILL.md @19392f7 · MIT
---
