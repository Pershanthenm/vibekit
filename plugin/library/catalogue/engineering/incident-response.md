...
domain: engineering
triggers: [incident response, has been detected, declared needs classification, triage, escalation path determination, forensic evidence collection]
...
source: alirezarezvani/claude-skills · engineering-team/skills/incident-response/SKILL.md @19392f7 · MIT
---
