...
domain: engineering
triggers: [git worktree manager, feature branches simultaneously, isolating experimental work, across same repo]
...
source: alirezarezvani/claude-skills · engineering/skills/git-worktree-manager/SKILL.md @19392f7 · MIT
---
