...
domain: engineering
triggers: [monorepo navigator, up new monorepo, ci large workspace, cross-package dependency issues, planning multi-repo consolidation]
description: Navigate, manage, and optimize monorepos. Covers Turborepo, Nx, pnpm workspaces, and Lerna.
source: alirezarezvani/claude-skills · engineering/skills/monorepo-navigator/SKILL.md @19392f7 · MIT
---
