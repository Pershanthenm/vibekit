...
name: hub-status
domain: engineering
triggers: [hub status, runs /hub:hub-status, how agenthub doing]
...
source: alirezarezvani/claude-skills · engineering/agenthub/skills/hub-status/SKILL.md @19392f7 · MIT
---
