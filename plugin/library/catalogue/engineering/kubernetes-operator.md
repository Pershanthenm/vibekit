...
domain: engineering
triggers: [kubernetes operator, build an operator, crd design, reconcile loop, controller-runtime, kubebuilder]
description: Use when building a Kubernetes Operator — custom controllers that reconcile CRD state.
source: alirezarezvani/claude-skills · engineering/kubernetes-operator/skills/kubernetes-operator/SKILL.md @19392f7 · MIT
---
