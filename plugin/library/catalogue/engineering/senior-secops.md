...
name: senior-secops
domain: engineering
triggers: [senior secops, conducting security review, audit, responding cve, security incident, hardening infrastructure]
description: Senior SecOps engineer skill for application security, vulnerability management, compliance verification, and secure development practices.
source: alirezarezvani/claude-skills · engineering-team/skills/senior-secops/SKILL.md @19392f7 · MIT
---
