...
name: slo-architect
domain: engineering
triggers: [slo architect, define an slo, should our slo, error budget, burn rate, sli]
description: Use when defining, reviewing, or operating SLOs/SLIs/error budgets.
source: alirezarezvani/claude-skills · engineering/skills/slo-architect/SKILL.md @19392f7 · MIT
---
