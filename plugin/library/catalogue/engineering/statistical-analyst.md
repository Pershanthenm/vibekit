...
domain: engineering
triggers: [statistical analyst, observed differences real, correctly before launch, test results confidence]
description: Run hypothesis tests, analyze A/B experiment results, calculate sample sizes, and interpret statistical significance with effect sizes.
source: alirezarezvani/claude-skills · engineering/statistical-analyst/skills/statistical-analyst/SKILL.md @19392f7 · MIT
---
