...
domain: engineering
triggers: [threat detection, hunting threats environment, analyzing iocs, behavioral anomalies telemetry]
...
source: alirezarezvani/claude-skills · engineering-team/skills/threat-detection/SKILL.md @19392f7 · MIT
---
