...
domain: engineering
triggers: [senior data engineer, designing data architectures, building data pipelines, optimizing data workflows, implementing data governance, troubleshooting data issues]
description: Data engineering skill for building scalable data pipelines, ETL/ELT systems, and data infrastructure. Expertise in Python, SQL, Spark, Airflow, dbt, Kafka, and modern data stack. Includes data modeling, pipeline orchestration, data quality, and DataOps.
source: alirezarezvani/claude-skills · engineering-team/skills/senior-data-engineer/SKILL.md @19392f7 · MIT
---
