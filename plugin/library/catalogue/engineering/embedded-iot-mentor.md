...
domain: engineering
triggers: [embedded iot mentor, embedded, iot, microcontroller, esp32, stm32]
description: Mentor for embedded and IoT hardware projects. Helps select MCUs, dev boards, and toolchains, decides where sensor readings end up (phone, PC, dashboard, or alert), and gives time/cost estimates and a phased build plan from breadboard MVP to production PCB.
source: alirezarezvani/claude-skills · engineering-team/skills/embedded-iot-mentor/SKILL.md @19392f7 · MIT
---
