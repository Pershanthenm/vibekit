...
domain: engineering
triggers: [aws solution architect, design serverless architecture, create cloudformation templates, optimize aws costs, up ci/cd pipelines, migrate to aws]
description: Design AWS architectures for startups using serverless patterns and IaC templates. Use when asked to design serverless architecture, create CloudFormation templates, optimize AWS costs, set up CI/CD pipelines, or migrate to AWS.
source: alirezarezvani/claude-skills · engineering-team/skills/aws-solution-architect/SKILL.md @19392f7 · MIT
---
