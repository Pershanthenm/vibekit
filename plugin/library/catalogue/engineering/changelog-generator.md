...
domain: engineering
triggers: [changelog generator, generate changelog v1.4.0, these commits require, emergency hotfix process, cutting a release, generating changelog]
description: Produce consistent, auditable release notes from Conventional Commits. Separates commit parsing, semantic-bump logic, and changelog rendering for automated releases with editorial control.
source: alirezarezvani/claude-skills · engineering/skills/changelog-generator/SKILL.md @19392f7 · MIT
---
