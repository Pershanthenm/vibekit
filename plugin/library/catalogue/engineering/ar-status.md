...
name: ar-status
domain: engineering
triggers: [ar status, runs /ar:ar-status, autoresearch experiment going]
...
source: alirezarezvani/claude-skills · engineering/autoresearch-agent/skills/ar-status/SKILL.md @19392f7 · MIT
---
