...
domain: engineering
triggers: [universal scraping architect, local python scripts, universal-scraping-architect]
...
source: alirezarezvani/claude-skills · engineering/universal-scraping-architect/skills/universal-scraping-architect/SKILL.md @19392f7 · MIT
---
