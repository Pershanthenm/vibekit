...
name: agent-designer
domain: engineering
triggers: [agent designer, architecture research automation, these tool descriptions, run logs bottlenecks, design multi-agent system, generate tool schemas]
description: Use when the user asks to design a multi-agent system, pick an orchestration pattern (supervisor/swarm/pipeline), generate tool schemas for agents, or evaluate agent execution logs for cost, latency, and failure bottlenecks.
source: alirezarezvani/claude-skills · engineering/skills/agent-designer/SKILL.md @19392f7 · MIT
---
