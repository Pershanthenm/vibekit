...
name: collab-proof
domain: engineering
triggers: [collab proof, /collab-proof, session retrospective, ai contribution analysis, collaboration evidence, what did do]
...
source: alirezarezvani/claude-skills · engineering/collab-proof/skills/collab-proof/SKILL.md @19392f7 · MIT
---
