...
name: extract
domain: engineering
triggers: [extract, runs /si:extract, recurring solution memory]
...
source: alirezarezvani/claude-skills · engineering-team/self-improving-agent/skills/extract/SKILL.md @19392f7 · MIT
---
