...
domain: engineering
triggers: [agent workflow designer, architecting multi-step pipeline, vs multi-agent approaches, suffers context bloat, unreliable handoffs]
description: Design production-grade multi-agent workflows with clear pattern choice (sequential, parallel, hierarchical), handoff contracts, failure handling, and cost/context controls.
source: alirezarezvani/claude-skills · engineering/skills/agent-workflow-designer/SKILL.md @19392f7 · MIT
---
