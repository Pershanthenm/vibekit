...
domain: engineering
triggers: [sample text processor, validating skill-tester itself, need minimal, known-good layout copy]
...
source: alirezarezvani/claude-skills · engineering/skills/skill-tester/assets/sample-skill/SKILL.md @19392f7 · MIT
---
