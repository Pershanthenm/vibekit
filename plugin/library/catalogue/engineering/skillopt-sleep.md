...
name: skillopt-sleep
domain: engineering
triggers: [skillopt sleep, sleep, dream, better more i, my past sessions, learn my preferences]
description: Use when the user wants their Claude agent to self-improve from past usage, asks about a nightly/offline 'sleep' or 'dream' cycle, memory/skill consolidation, or says things like 'make my agent better the more I use it', 'review my past sessions', 'learn my…
source: alirezarezvani/claude-skills · engineering/skillopt-sleep/skills/skillopt-sleep/SKILL.md @19392f7 · MIT
---
