...
name: karpathy-coder
domain: engineering
triggers: [karpathy coder, review my diff, check complexity, am i overcomplicating, karpathy check, before i commit]
...
source: alirezarezvani/claude-skills · engineering/karpathy-coder/skills/karpathy-coder/SKILL.md @19392f7 · MIT
---
