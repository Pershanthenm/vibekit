...
name: testrail
domain: engineering
triggers: [testrail, test management, test cases, test run, sync test cases, push results testrail]
...
source: alirezarezvani/claude-skills · engineering-team/playwright-pro/skills/testrail/SKILL.md @19392f7 · MIT
---
