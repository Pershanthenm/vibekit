...
domain: engineering
triggers: [memory engineering, designing, reviewing, — adding memory, / agentic memory, auditing what]
description: Use when designing, reviewing, or paying for an agent memory system — adding memory to an agent, choosing between long-context / RAG / graph / agentic memory, auditing what a CLAUDE.md or memory directory actually holds, deciding what to keep and what to…
source: alirezarezvani/claude-skills · engineering/memory-engineering/skills/memory-engineering/SKILL.md @19392f7 · MIT
---
