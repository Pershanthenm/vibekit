...
name: hivemind
domain: engineering
triggers: [hivemind, spawn a worker, swarm, delegate to opencode, /oc, work single worker]
description: Orchestrate free opencode workers from Claude Code to cut token costs.
source: alirezarezvani/claude-skills · engineering/hivemind/SKILL.md @19392f7 · MIT
---
