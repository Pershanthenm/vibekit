...
name: pw-init
domain: engineering
triggers: [pw init, set up playwright, add e2e tests, configure playwright, testing setup, init playwright]
...
source: alirezarezvani/claude-skills · engineering-team/playwright-pro/skills/pw-init/SKILL.md @19392f7 · MIT
---
