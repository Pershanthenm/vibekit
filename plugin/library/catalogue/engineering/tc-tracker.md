...
name: tc-tracker
domain: engineering
triggers: [tc tracker, track technical changes, create change records, manage tc lifecycles, between ai sessions]
...
source: alirezarezvani/claude-skills · engineering/skills/tc-tracker/SKILL.md @19392f7 · MIT
---
