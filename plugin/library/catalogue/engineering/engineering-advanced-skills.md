...
domain: engineering
triggers: [engineering advanced skills, browsing, engineering skills: design, rag, mcp servers, ci/cd]
description: Index of 37 advanced engineering agent skills for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw.
source: alirezarezvani/claude-skills · engineering/skills/engineering-advanced-skills/SKILL.md @19392f7 · MIT
---
