...
domain: engineering
triggers: [senior architect, design system architecture, microservices vs monolith, create architecture diagrams, analyze dependencies, choose a database]
description: This skill should be used when the user asks to "design system architecture", "evaluate microservices vs monolith", "create architecture diagrams", "analyze dependencies", "choose a database", "plan for scalability", "make technical decisions", or "review…
source: alirezarezvani/claude-skills · engineering-team/skills/senior-architect/SKILL.md @19392f7 · MIT
---
