...
name: board
domain: engineering
triggers: [board, runs /hub:board, asks to post, read, between competing agenthub]
...
source: alirezarezvani/claude-skills · engineering/agenthub/skills/board/SKILL.md @19392f7 · MIT
---
