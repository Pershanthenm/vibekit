...
domain: engineering
triggers: [ms365 tenant manager, administration global administrators, administration, security policies, management, compliance reporting]
description: Microsoft 365 tenant administration for Global Administrators. Automate M365 tenant setup, Office 365 admin tasks, Azure AD user management, Exchange Online configuration, Teams administration, and security policies.
source: alirezarezvani/claude-skills · engineering-team/skills/ms365-tenant-manager/SKILL.md @19392f7 · MIT
---
