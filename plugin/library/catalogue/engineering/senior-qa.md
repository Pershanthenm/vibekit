...
name: senior-qa
domain: engineering
triggers: [senior qa, generate tests, write unit tests, analyze test coverage, scaffold e2e tests, set up playwright]
description: Generates unit tests, integration tests, and E2E tests for React/Next.js applications.
source: alirezarezvani/claude-skills · engineering-team/skills/senior-qa/SKILL.md @19392f7 · MIT
---
