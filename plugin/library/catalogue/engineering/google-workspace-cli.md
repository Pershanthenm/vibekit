...
domain: engineering
triggers: [google workspace cli, gws cli github, com/googleworkspace/cli, docs, chat, tasks]
description: Google Workspace administration via the gws CLI (github.com/googleworkspace/cli). Install, authenticate, and automate Gmail, Drive, Sheets, Calendar, Docs, Chat, and Tasks. Run security audits and use local recipe templates and persona bundles.
source: alirezarezvani/claude-skills · engineering-team/google-workspace-cli/skills/google-workspace-cli/SKILL.md @19392f7 · MIT
---
