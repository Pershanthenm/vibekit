...
name: memory-review
domain: engineering
triggers: [memory review, runs /si:memory-review, what should promoted, pruned]
...
source: alirezarezvani/claude-skills · engineering-team/self-improving-agent/skills/memory-review/SKILL.md @19392f7 · MIT
---
