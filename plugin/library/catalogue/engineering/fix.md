...
name: fix
domain: engineering
triggers: [fix, fix test, flaky test, test failing, debug test, test broken]
...
source: alirezarezvani/claude-skills · engineering-team/playwright-pro/skills/fix/SKILL.md @19392f7 · MIT
---
