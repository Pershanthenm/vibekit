...
domain: engineering
triggers: [mcp server builder, api mcp server, building tool integrations, codex, cursor, mcp project scratch]
...
source: alirezarezvani/claude-skills · engineering/skills/mcp-server-builder/SKILL.md @19392f7 · MIT
---
