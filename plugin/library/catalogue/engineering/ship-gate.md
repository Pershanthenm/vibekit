...
name: ship-gate
domain: engineering
triggers: [ship gate, run ship gate, i ready ship, pre-launch audit, can i deploy, push to production]
...
source: alirezarezvani/claude-skills · engineering/skills/ship-gate/SKILL.md @19392f7 · MIT
---
