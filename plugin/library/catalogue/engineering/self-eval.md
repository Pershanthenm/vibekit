...
name: self-eval
domain: engineering
triggers: [self eval, two-axis scoring system, get unbiased assessment, scores across sessions]
...
source: alirezarezvani/claude-skills · engineering/skills/self-eval/SKILL.md @19392f7 · MIT
---
