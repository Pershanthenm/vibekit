...
name: report
domain: engineering
triggers: [report, test report, results summary, test status, show results, test dashboard]
...
source: alirezarezvani/claude-skills · engineering-team/playwright-pro/skills/report/SKILL.md @19392f7 · MIT
---
