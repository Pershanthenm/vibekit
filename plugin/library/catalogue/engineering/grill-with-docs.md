...
domain: engineering
triggers: [grill with docs, documented domain language, mentions grill docs]
...
source: alirezarezvani/claude-skills · engineering/grill-with-docs/skills/grill-with-docs/SKILL.md @19392f7 · MIT
---
