...
domain: engineering
triggers: [secrets vault manager, secret management infrastructure, integrate hashicorp vault, aws secrets manager, azure key vault, gcp secret manager]
...
source: alirezarezvani/claude-skills · engineering/skills/secrets-vault-manager/SKILL.md @19392f7 · MIT
---
