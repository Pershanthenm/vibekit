...
domain: engineering
triggers: [senior data scientist, designing, analysing controlled experiments, building evaluating classification, regression models, analysis observational data]
description: World-class senior data scientist skill specialising in statistical modeling, experiment design, causal inference, and predictive analytics.
source: alirezarezvani/claude-skills · engineering-team/skills/senior-data-scientist/SKILL.md @19392f7 · MIT
---
