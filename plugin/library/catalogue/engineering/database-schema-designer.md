...
domain: engineering
triggers: [database schema designer, create erd diagrams, normalize database schemas, design table relationships, plan schema migrations]
...
source: alirezarezvani/claude-skills · engineering/skills/database-schema-designer/SKILL.md @19392f7 · MIT
---
