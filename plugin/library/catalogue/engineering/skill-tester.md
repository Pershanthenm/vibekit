...
name: skill-tester
domain: engineering
triggers: [skill tester, authoring new, existing skills promotion, pre-commit hooks quality, integrating qa ci]
description: Validate, test, and score the quality of skills within the claude-skills ecosystem.
source: alirezarezvani/claude-skills · engineering/skills/skill-tester/SKILL.md @19392f7 · MIT
---
