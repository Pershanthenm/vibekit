...
domain: engineering
triggers: [runbook generator, procedures new service, response across teams, runbooks before launching]
description: Generate operational runbooks from a service name — deployment, incident response, maintenance, and rollback workflows. Templated structure customizable per environment.
