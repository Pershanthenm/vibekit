...
domain: engineering
triggers: [self improving agent, durable project knowledge, analyze memory, promote proven learnings]
...
source: alirezarezvani/claude-skills · engineering-team/self-improving-agent/skills/self-improving-agent/SKILL.md @19392f7 · MIT
---
