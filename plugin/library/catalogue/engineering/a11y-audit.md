...
name: a11y-audit
domain: engineering
triggers: [a11y audit, auditing accessibility, fixing a11y violations, checking color contrast, generating compliance reports, checks ci/cd pipelines]
description: Accessibility audit skill for scanning, fixing, and verifying WCAG 2.2 Level A and AA compliance across React, Next.js, Vue, Angular, Svelte, and plain HTML codebases.
