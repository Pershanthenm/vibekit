...
name: skill-doctor
domain: engineering
triggers: [skill doctor, real conversation history, skills actually working, efficiency code-quality rubrics, local shareable report]
description: Use when the user wants their agent setup graded from real conversation history, asks which installed skills are actually working, or wants evidence-backed skill edits — scores recent local Claude Code / Codex sessions against efficiency and code-quality…
source: alirezarezvani/claude-skills · engineering/skill-doctor/skills/skill-doctor/SKILL.md @19392f7 · MIT
---
