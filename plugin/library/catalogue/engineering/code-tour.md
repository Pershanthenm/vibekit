...
name: code-tour
domain: engineering
triggers: [code tour, for: create tour, onboarding tour, architecture tour, pr review tour, how x works]
description: Use when the user asks to create a CodeTour .tour file — persona-targeted, step-by-step walkthroughs that link to real files and line numbers.
source: alirezarezvani/claude-skills · engineering/code-tour/skills/code-tour/SKILL.md @19392f7 · MIT
---
