...
domain: engineering
triggers: [engineering skills, browsing, load only one]
description: Index of the engineering-team skills bundle for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw, and 6 more tools. Architecture, frontend, backend, QA, DevOps, security, AI/ML, data engineering, Playwright, Stripe, AWS, MS365 (stdlib-only Python tools).
source: alirezarezvani/claude-skills · engineering-team/skills/engineering-skills/SKILL.md @19392f7 · MIT
---
