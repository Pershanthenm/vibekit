...
domain: engineering
triggers: [skill security auditor, audit this skill, safe, scan security, check before install, skill security check]
description: Security audit and vulnerability scanner for AI agent skills before installation.
source: alirezarezvani/claude-skills · engineering/skills/skill-security-auditor/SKILL.md @19392f7 · MIT
---
