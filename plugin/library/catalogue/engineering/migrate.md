...
name: migrate
domain: engineering
triggers: [migrate, cypress, selenium, migrate tests, convert tests, switch to playwright]
...
source: alirezarezvani/claude-skills · engineering-team/playwright-pro/skills/migrate/SKILL.md @19392f7 · MIT
---
