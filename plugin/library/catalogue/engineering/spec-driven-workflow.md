...
domain: engineering
triggers: [spec driven workflow, write specs before, define acceptance criteria, features before implementation, generate tests specifications, spec-first development practices]
...
source: alirezarezvani/claude-skills · engineering/skills/spec-driven-workflow/SKILL.md @19392f7 · MIT
---
