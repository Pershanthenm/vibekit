...
name: agenthub
domain: engineering
triggers: [agenthub, git worktree isolation, best branch merged]
description: Multi-agent collaboration plugin that spawns N parallel subagents competing on the same task via git worktree isolation. Agents work independently, results are evaluated by metric or LLM judge, and the best branch is merged.
source: alirezarezvani/claude-skills · engineering/agenthub/skills/agenthub/SKILL.md @19392f7 · MIT
---
