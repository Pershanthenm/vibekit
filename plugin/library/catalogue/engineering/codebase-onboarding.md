...
domain: engineering
triggers: [codebase onboarding, onboarding new engineer, docs new project, briefings unfamiliar repos]
description: Analyze a codebase and generate onboarding documentation for engineers, tech leads, and contractors. Fast fact-gathering and repeatable onboarding outputs.
source: alirezarezvani/claude-skills · engineering/skills/codebase-onboarding/SKILL.md @19392f7 · MIT
---
