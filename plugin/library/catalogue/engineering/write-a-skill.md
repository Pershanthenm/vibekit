...
name: write-a-skill
domain: engineering
triggers: [write a skill, create, write, build, author new]
...
source: alirezarezvani/claude-skills · engineering/write-a-skill/skills/write-a-skill/SKILL.md @19392f7 · MIT
---
