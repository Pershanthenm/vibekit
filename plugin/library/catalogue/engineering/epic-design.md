...
name: epic-design
domain: engineering
triggers: [epic design, make feel alive, apple-style animation, sections that overlap, rises between sections, immersive]
description: Build immersive, cinematic 2.5D interactive websites using scroll storytelling, parallax depth, text animations, and premium scroll effects — no WebGL required.
source: alirezarezvani/claude-skills · engineering-team/skills/epic-design/SKILL.md @19392f7 · MIT
---
