...
domain: engineering
triggers: [senior frontend, building react components, optimizing next]
description: Frontend development skill for React, Next.js, TypeScript, and Tailwind CSS applications.
