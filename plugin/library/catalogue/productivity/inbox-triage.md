...
name: inbox-triage
domain: productivity
triggers: [inbox triage, inbox-setup, triage my inbox, check my email, run email triage, process my inbox]
description: Runs a full inbox triage using the knowledge base created by the 'inbox-setup' skill.
source: alirezarezvani/claude-skills · productivity/email/skills/inbox-triage/SKILL.md @19392f7 · MIT
---
