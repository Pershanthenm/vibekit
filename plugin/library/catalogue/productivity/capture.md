...
name: capture
domain: productivity
triggers: [capture, capture this, brain dump, dump some ideas, got bunch thoughts, here]
description: Captures and organizes chaotic brain dumps into a structured, actionable system with zero information loss.
source: alirezarezvani/claude-skills · productivity/capture/skills/capture/SKILL.md @19392f7 · MIT
---
