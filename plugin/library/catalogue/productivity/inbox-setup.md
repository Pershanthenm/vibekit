...
name: inbox-setup
domain: productivity
triggers: [inbox setup, inbox-triage, up my inbox, configure inbox triage, my email system, configure email triage]
description: One-time setup skill that builds a personalized inbox triage knowledge base via interactive interview.
source: alirezarezvani/claude-skills · productivity/email/skills/inbox-setup/SKILL.md @19392f7 · MIT
---
