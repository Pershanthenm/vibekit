...
name: swedish-mentor
domain: productivity
triggers: [swedish mentor, swedish learning path, youtube clips, podcasts for swedish, sfi videos, level assessment svenska]
description: Mentor Swedish language learners by selecting YouTube video clips and podcast episodes by CEFR level and skill (listening, reading, writing, speaking), and building a simple learning path.
source: alirezarezvani/claude-skills · productivity/swedish-mentor/SKILL.md @19392f7 · MIT
---
