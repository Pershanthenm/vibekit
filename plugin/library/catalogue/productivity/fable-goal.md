...
name: fable-goal
domain: productivity
triggers: [fable goal, /fable-goal, turn goal prompt, me fable prompt, prompt builds x, prompt makes happen]
description: Convert a rambling description of a desired outcome into one polished, autonomous /goal prompt ready to paste into a fresh session.
source: alirezarezvani/claude-skills · productivity/fable-goal/skills/fable-goal/SKILL.md @19392f7 · MIT
---
