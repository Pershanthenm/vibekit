...
triggers: [stage launch, anthropic key. says, deploy the agent, create now, launch it, orchestrator routes phase=stage-launch]
description: Phase 2 of building a Claude Managed Agent — turn a validated build sheet into exact API payloads and a resumable BYOK curl launch script, then launch (environment → agent → session → kickoff) using the founder's OWN Anthropic key.
source: alirezarezvani/claude-skills · agent-launcher/skills/stage-launch/SKILL.md @19392f7 · MIT
---
