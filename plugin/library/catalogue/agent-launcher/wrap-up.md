...
triggers: [wrap up, close this out, i own now, give me summary, recap the agent, orchestrator routes phase=wrap-up]
description: Close out a launched Claude Managed Agent — recap every primitive the founder now owns, regenerate the single-file overview page, and suggest the next 1-2 upgrades.
source: alirezarezvani/claude-skills · agent-launcher/skills/wrap-up/SKILL.md @19392f7 · MIT
---
