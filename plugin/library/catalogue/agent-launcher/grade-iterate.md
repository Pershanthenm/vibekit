...
triggers: [grade iterate, grade my agent, make pass rubric, iterate until it, good enough, iterate until good]
description: Phase 3 of building a Claude Managed Agent — the bounded grade→iterate loop.
source: alirezarezvani/claude-skills · agent-launcher/skills/grade-iterate/SKILL.md @19392f7 · MIT
---
