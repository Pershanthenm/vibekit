...
triggers: [interview, help me scope, i have idea, what should, inputs, actions]
description: Phase 1 of building a Claude Managed Agent — interview the founder about the one job the agent should do, then produce a build sheet (CMA primitives table + v1/v2 deferrals + eval plan) WITHOUT needing their API key yet.
source: alirezarezvani/claude-skills · agent-launcher/skills/interview/SKILL.md @19392f7 · MIT
---
