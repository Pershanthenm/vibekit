...
domain: ra-qm
triggers: [agent decision receipts, need proven later, act article record-keeping]
...
source: alirezarezvani/claude-skills · ra-qm-team/skills/agent-decision-receipts/SKILL.md @19392f7 · MIT
---
