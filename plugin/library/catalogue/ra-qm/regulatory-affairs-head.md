...
domain: ra-qm
triggers: [regulatory affairs head, need plan, execute fda submissions, navigate 510k, pma approval processes, achieve ce marking]
description: Senior Regulatory Affairs Manager for HealthTech and MedTech companies.
source: alirezarezvani/claude-skills · ra-qm-team/skills/regulatory-affairs-head/SKILL.md @19392f7 · MIT
---
