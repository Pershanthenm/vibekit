...
domain: ra-qm
triggers: [soc2 compliance, prepare soc audits, trust service criteria, build control matrices, collect audit evidence, perform gap analysis]
...
source: alirezarezvani/claude-skills · ra-qm-team/skills/soc2-compliance/SKILL.md @19392f7 · MIT
---
