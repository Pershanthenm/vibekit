...
triggers: [capacity planner, thresholds, ramp + attrition, leader director cx, head of support, vp ops]
description: Use when an ops leader (Director of CX, Head of Support, VP Ops, Head of BizOps, Head of IT ops, Head of Finance ops) is sizing ops capacity, building a headcount plan, modeling utilization risk, planning Q3 capacity or annual support capacity, or designing…
source: alirezarezvani/claude-skills · business-operations/skills/capacity-planner/SKILL.md @19392f7 · MIT
---
