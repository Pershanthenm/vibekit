...
triggers: [vendor management, parent thread. triggers, vendor scorecard, third-party risk, tprm, vendor review]
description: Use when reviewing, scoring, or auditing third-party SaaS / vendor relationships — running a vendor scorecard with industry tuning, tracking SLA compliance with credit-claim flags, classifying third-party risk across 4 risk vectors, preparing a tier-1 vendor…
source: alirezarezvani/claude-skills · business-operations/skills/vendor-management/SKILL.md @19392f7 · MIT
---
