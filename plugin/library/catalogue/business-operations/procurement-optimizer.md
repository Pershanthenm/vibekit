...
triggers: [procurement optimizer, spend audit, saas audit, spend categorization, supplier rationalization, supplier consolidation]
description: Use when running an annual SaaS audit, doing category-level spend review, or rationalizing the supplier base — when the user needs a spend audit, spend categorization (UNSPSC-aligned with Pareto breakdown and industry profiles), purchasing-cycle analysis…
source: alirezarezvani/claude-skills · business-operations/skills/procurement-optimizer/SKILL.md @19392f7 · MIT
---
