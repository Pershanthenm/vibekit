...
triggers: [confluence expert, need build, restructure confluence space, hierarchies permission structures, author, standardise documentation templates]
description: Atlassian Confluence expert for creating and managing spaces, knowledge bases, and documentation.
source: alirezarezvani/claude-skills · project-management/skills/confluence-expert/SKILL.md @19392f7 · MIT
---
