...
triggers: [atlassian admin, add jira, change confluence permissions, configure access control, update admin settings, manage atlassian groups]
...
source: alirezarezvani/claude-skills · project-management/skills/atlassian-admin/SKILL.md @19392f7 · MIT
---
