...
triggers: [pm skills, sprints feel off, project health report, our jira permissions, will done, run delivery loop]
description: Use when coordinating project-delivery work across the 8 project-management sub-skills — sprint/velocity analytics, portfolio health, Jira/JQL, Confluence, Atlassian admin, templates, meeting analysis, team comms.
source: alirezarezvani/claude-skills · project-management/skills/pm-skills/SKILL.md @19392f7 · MIT
---
