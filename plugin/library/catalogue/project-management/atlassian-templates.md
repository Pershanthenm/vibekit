...
triggers: [atlassian templates, building org-wide templates, custom blueprints, page layouts, automated content generation]
...
source: alirezarezvani/claude-skills · project-management/skills/atlassian-templates/SKILL.md @19392f7 · MIT
---
