...
name: stock-analysis
domain: finance
triggers: [stock analysis, profit real, but cash isn, i apply ipo, infosys good, analyse]
description: Produce a rigorous, sector-relative, multi-factor fundamental analysis of a publicly listed company — Indian (NSE/BSE) or US/global.
source: alirezarezvani/claude-skills · finance/skills/stock-analysis/SKILL.md @19392f7 · MIT
---
