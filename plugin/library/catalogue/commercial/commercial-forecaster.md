...
domain: commercial
triggers: [commercial forecaster, quarterly bookings forecast, arr projection, pipeline forecast, nrr projection, single undefended number]
description: Use when building a quarterly bookings forecast, ARR projection, pipeline forecast, NRR projection, or commit/best-case/pipe-only board number — especially when the CRO needs to walk the board through funnel math + cohort ARR + per-stage conversion…
source: alirezarezvani/claude-skills · commercial/skills/commercial-forecaster/SKILL.md @19392f7 · MIT
---
