...
domain: commercial
triggers: [pricing strategist, designing, model subscription seat-based, usage-based, value-based, freemium]
description: Use when designing or revisiting product pricing — selecting a pricing model (subscription seat-based, usage-based, value-based, freemium, or hybrid), running Van Westendorp Price Sensitivity Meter analysis on WTP survey data, or designing Good/Better/Best…
source: alirezarezvani/claude-skills · commercial/skills/pricing-strategist/SKILL.md @19392f7 · MIT
---
