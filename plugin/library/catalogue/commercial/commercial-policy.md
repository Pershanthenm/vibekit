...
domain: commercial
triggers: [commercial policy, designing, off list price, approver thresholds, exception flows, aes operate under]
...
source: alirezarezvani/claude-skills · commercial/skills/commercial-policy/SKILL.md @19392f7 · MIT
---
