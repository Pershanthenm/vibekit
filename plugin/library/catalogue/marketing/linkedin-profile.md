...
domain: marketing
triggers: [linkedin profile, fix my headline, but nothing happens, my linkedin profile, my section say, …see more]
description: Use when someone wants their LinkedIn profile audited or rewritten — headline, About section, experience bullets, Featured, banner, recommendations — or says "fix my headline", "my profile gets views but nothing happens", "optimize my LinkedIn profile", "what…
source: alirezarezvani/claude-skills · marketing/linkedin/skills/linkedin-profile/SKILL.md @19392f7 · MIT
---
