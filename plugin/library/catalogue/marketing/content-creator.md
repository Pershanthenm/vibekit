...
domain: marketing
triggers: [content creator, invokes content creator, write blog post, article, guide, analysis routes content-production]
description: Deprecated redirect skill that routes legacy 'content creator' requests to the correct specialist.
source: alirezarezvani/claude-skills · marketing-skill/skills/content-creator/SKILL.md @19392f7 · MIT
---
