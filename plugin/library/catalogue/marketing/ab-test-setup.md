...
name: ab-test-setup
domain: marketing
triggers: [ab test setup, a/b test,, split test,, experiment,, test this change,, variant copy,]
description: When the user wants to plan, design, or implement an A/B test or experiment.
source: alirezarezvani/claude-skills · marketing-skill/skills/ab-test-setup/SKILL.md @19392f7 · MIT
---
