...
domain: marketing
triggers: [paywall upgrade cro, paywall,, upgrade screen,, upgrade modal,, upsell,, feature gate,]
description: When the user wants to create or optimize in-app paywalls, upgrade screens, upsell modals, or feature gates.
source: alirezarezvani/claude-skills · marketing-skill/skills/paywall-upgrade-cro/SKILL.md @19392f7 · MIT
---
