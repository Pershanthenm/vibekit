...
domain: marketing
triggers: [linkedin skills, grow my linkedin, fix my headline, write linkedin post, should i post, linkedin strategy]
description: Use when someone wants to grow an organic LinkedIn presence — a content strategy for a career change or consulting or thought leadership, a rewritten profile or headline, post drafts and hooks, a posting cadence or newsletter plan, connection notes and…
source: alirezarezvani/claude-skills · marketing/linkedin/skills/linkedin-skills/SKILL.md @19392f7 · MIT
---
