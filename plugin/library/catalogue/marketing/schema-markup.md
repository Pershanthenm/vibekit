...
name: schema-markup
domain: marketing
triggers: [schema markup, structured data,, schema.org,, json-ld,, rich results,, rich snippets,]
description: When the user wants to implement, audit, or validate structured data (schema markup) on their website.
source: alirezarezvani/claude-skills · marketing-skill/skills/schema-markup/SKILL.md @19392f7 · MIT
---
