...
name: onboarding-cro
domain: marketing
triggers: [onboarding cro, onboarding flow,, activation rate,, user activation,, first-run experience,, empty states,]
description: When the user wants to optimize post-signup onboarding, user activation, first-run experience, or time-to-value.
source: alirezarezvani/claude-skills · marketing-skill/skills/onboarding-cro/SKILL.md @19392f7 · MIT
---
