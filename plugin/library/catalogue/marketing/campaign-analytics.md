...
domain: marketing
triggers: [campaign analytics, analyzing marketing campaigns, ad performance, attribution models, conversion rates, calculating marketing roi]
description: Analyzes campaign performance with multi-touch attribution, funnel conversion analysis, and ROI calculation for marketing optimization.
source: alirezarezvani/claude-skills · marketing-skill/skills/campaign-analytics/SKILL.md @19392f7 · MIT
---
