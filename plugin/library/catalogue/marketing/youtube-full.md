...
name: youtube-full
domain: marketing
triggers: [youtube full, get transcript, search youtube for, what latest videos, list this playlist, monitor this channel]
description: Use when the user needs YouTube transcripts, video search, channel browsing, playlist extraction, or content monitoring.
source: alirezarezvani/claude-skills · marketing-skill/skills/youtube-full/SKILL.md @19392f7 · MIT
---
