...
name: aeo
domain: marketing
triggers: [aeo, aeo audit, optimize for chatgpt, get cited perplexity, llm citation strategy, answer engine optimization]
description: Answer Engine Optimization (AEO) skill — optimize content to be cited by AI language models (ChatGPT, Perplexity, Claude, Gemini, Mistral) as authoritative sources.
source: alirezarezvani/claude-skills · marketing-skill/skills/aeo/SKILL.md @19392f7 · MIT
---
