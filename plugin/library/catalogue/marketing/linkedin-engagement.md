...
domain: marketing
triggers: [linkedin engagement, should i engage, write connection request, cold dm, linkedin outreach, networking strategy]
description: Use when someone wants to grow reach through comments, replies, groups, or outreach on LinkedIn — a commenting roster, a connection request note, a DM or InMail, a networking plan, or a check on whether their outreach volume is safe.
source: alirezarezvani/claude-skills · marketing/linkedin/skills/linkedin-engagement/SKILL.md @19392f7 · MIT
---
