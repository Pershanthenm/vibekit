...
domain: marketing
triggers: [programmatic seo, programmatic seo,, template pages,, pages at scale,, directory pages,, location pages,]
description: When the user wants to create SEO-driven pages at scale using templates and data.
source: alirezarezvani/claude-skills · marketing-skill/skills/programmatic-seo/SKILL.md @19392f7 · MIT
---
