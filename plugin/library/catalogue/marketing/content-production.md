...
domain: marketing
triggers: [content production, write post, draft an article, create content for, help me write, need blog post]
...
source: alirezarezvani/claude-skills · marketing-skill/skills/content-production/SKILL.md @19392f7 · MIT
---
