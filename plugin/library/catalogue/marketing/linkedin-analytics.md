...
domain: marketing
triggers: [linkedin analytics, my reach drop, what, analyze my posts, do better me, should i test]
description: Use when someone wants to understand their own LinkedIn numbers — which posts worked, why reach dropped, whether a pattern is real, or how to test a hypothesis.
source: alirezarezvani/claude-skills · marketing/linkedin/skills/linkedin-analytics/SKILL.md @19392f7 · MIT
---
