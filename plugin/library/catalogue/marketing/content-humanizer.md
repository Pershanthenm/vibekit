...
domain: marketing
triggers: [content humanizer, sounds like ai, make more human, add personality, it feels generic, sounds robotic]
description: Makes AI-generated content sound genuinely human — not just cleaned up, but alive. Use when content feels robotic, uses too many AI clichés, lacks personality, or reads like it was written by committee.
source: alirezarezvani/claude-skills · marketing-skill/skills/content-humanizer/SKILL.md @19392f7 · MIT
---
