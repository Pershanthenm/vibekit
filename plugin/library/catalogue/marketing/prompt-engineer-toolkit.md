...
domain: marketing
triggers: [prompt engineer toolkit, prompt engineering,, improve my prompts,, prompt templates,, prompt versioning,, ai content workflow,]
description: Turns marketing prompts into tested, versioned production assets: A/B prompt evaluation against structured test cases, immutable prompt version history with diffs, ready-to-use marketing prompt templates (ad copy, email campaigns, social posts, landing pages,…
source: alirezarezvani/claude-skills · marketing-skill/skills/prompt-engineer-toolkit/SKILL.md @19392f7 · MIT
---
