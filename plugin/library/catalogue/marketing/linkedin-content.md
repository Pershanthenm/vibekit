...
domain: marketing
triggers: [linkedin content, write linkedin post, hook good, review my post, turn linkedin posts, carousel]
description: Use when someone wants to write, edit, or lint a LinkedIn post — a story, how-to, opinion piece, carousel script, video script, or poll — or wants an article, talk, or transcript repurposed into posts.
source: alirezarezvani/claude-skills · marketing/linkedin/skills/linkedin-content/SKILL.md @19392f7 · MIT
---
