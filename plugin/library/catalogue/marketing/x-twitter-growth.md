...
domain: marketing
triggers: [x twitter growth, grow on x/twitter, write tweets, threads, their x profile, research competitors x]
description: X/Twitter growth engine for building audience, crafting viral content, and analyzing engagement.
source: alirezarezvani/claude-skills · marketing-skill/skills/x-twitter-growth/SKILL.md @19392f7 · MIT
---
