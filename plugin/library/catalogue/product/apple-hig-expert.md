...
domain: product
triggers: [apple hig expert, app against hig, readable liquid glass, reviewing apple-platform mockup, app hig compliance, checking contrast]
description: Audits and designs iOS/macOS/watchOS/visionOS interfaces against the Apple Human Interface Guidelines, including the Liquid Glass design language (announced WWDC25, shipped with iOS 26/macOS Tahoe, Sept 2025).
source: alirezarezvani/claude-skills · product-team/apple-hig-expert/skills/apple-hig-expert/SKILL.md @19392f7 · MIT
---
