...
domain: product
triggers: [saas scaffolder, new saas app, subscription-based web project, scaffold a next]
description: Generates complete, production-ready SaaS project boilerplate including authentication, database schemas, billing integration, API routes, and a working dashboard using Next.js 14+ App Router, TypeScript, Tailwind CSS, shadcn/ui, Drizzle ORM, and Stripe.
source: alirezarezvani/claude-skills · product-team/skills/saas-scaffolder/SKILL.md @19392f7 · MIT
---
