...
domain: product
triggers: [product manager toolkit, prioritizing features, synthesizing user research, writing requirement documentation, developing product strategy]
...
source: alirezarezvani/claude-skills · product-team/skills/product-manager-toolkit/SKILL.md @19392f7 · MIT
---
