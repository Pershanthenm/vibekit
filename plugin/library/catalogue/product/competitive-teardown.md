...
domain: product
triggers: [competitive teardown, conducting competitor analysis, products against competitors, researching competitive landscape, battle cards sales, preparing product strategy]
description: Analyzes competitor products and companies by synthesizing data from pricing pages, app store reviews, job postings, SEO signals, and social media into structured competitive intelligence.
source: alirezarezvani/claude-skills · product-team/skills/competitive-teardown/SKILL.md @19392f7 · MIT
---
