...
name: code-to-prd
domain: product
triggers: [code to prd, mention: generate prd, reverse-engineer requirements, code to documentation, extract product specs, document page logic]
description: Reverse-engineer any codebase into a complete Product Requirements Document (PRD).
source: alirezarezvani/claude-skills · product-team/code-to-prd/skills/code-to-prd/SKILL.md @19392f7 · MIT
---
