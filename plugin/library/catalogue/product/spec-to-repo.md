...
name: spec-to-repo
domain: product
triggers: [spec to repo, build me app, create project spec, scaffold new repo, generate a starter, turn idea]
description: Use when the user says 'build me an app', 'create a project from this spec', 'scaffold a new repo', 'generate a starter', 'turn this idea into code', 'bootstrap a project', 'I have requirements and need a codebase', or provides a natural-language project…
source: alirezarezvani/claude-skills · product-team/skills/spec-to-repo/SKILL.md @19392f7 · MIT
---
