...
domain: product
triggers: [research summarizer, research summarization non-dev, articles, reports, documentation, properly formatted citations]
description: Structured research summarization agent skill for non-dev users. Handles academic papers, web articles, reports, and documentation. Extracts key findings, generates comparative analyses, and produces properly formatted citations.
source: alirezarezvani/claude-skills · product-team/research-summarizer/skills/research-summarizer/SKILL.md @19392f7 · MIT
---
