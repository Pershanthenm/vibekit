...
name: product-skills
domain: product
triggers: [product skills, help me prioritize, plan product experiment, features nobody uses, run discovery loop, our ost sound]
description: Use when coordinating product work across the 12 bundled product sub-skills (RICE, OKRs, UX research, design tokens, competitive teardown, analytics, experiments, discovery, roadmaps, spec-to-repo, landing pages, SaaS scaffolding) or the 4 standalone…
source: alirezarezvani/claude-skills · product-team/skills/product-skills/SKILL.md @19392f7 · MIT
---
