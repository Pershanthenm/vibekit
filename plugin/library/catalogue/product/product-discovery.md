...
domain: product
triggers: [product discovery, validating product opportunities, mapping assumptions, planning discovery sprints, committing delivery resources]
...
source: alirezarezvani/claude-skills · product-team/skills/product-discovery/SKILL.md @19392f7 · MIT
---
