...
domain: product
triggers: [product analytics, defining product kpis, building metric dashboards, running cohort, retention analysis, across product stages]
...
source: alirezarezvani/claude-skills · product-team/skills/product-analytics/SKILL.md @19392f7 · MIT
---
