...
domain: product
triggers: [landing page generator, create landing page, marketing page, homepage, single-page site, lead capture page]
description: Generates high-converting landing pages as complete Next.js/React (TSX) components with Tailwind CSS. Creates hero sections, feature grids, pricing tables, FAQ accordions, testimonial blocks, and CTA sections using proven copy frameworks (PAS, AIDA, BAB).
source: alirezarezvani/claude-skills · product-team/skills/landing-page-generator/SKILL.md @19392f7 · MIT
---
