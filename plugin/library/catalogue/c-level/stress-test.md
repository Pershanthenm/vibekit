...
name: stress-test
domain: c-level
triggers: [stress test, tolerate 6-month pilot, /em, assumption stress testing, unvalidated — e]
...
source: alirezarezvani/claude-skills · c-level-advisor/executive-mentor/skills/stress-test/SKILL.md @19392f7 · MIT
---
