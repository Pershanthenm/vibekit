...
name: cro-advisor
domain: c-level
triggers: [cro advisor, designing revenue engine, setting quotas, modeling nrr, evaluating pricing, building board forecasts]
...
source: alirezarezvani/claude-skills · c-level-advisor/skills/cro-advisor/SKILL.md @19392f7 · MIT
---
