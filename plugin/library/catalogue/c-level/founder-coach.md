...
name: founder-coach
domain: c-level
triggers: [founder coach, feels like bottleneck, struggles to delegate, is burning out, transitioning ic executive, managing a board]
description: Personal leadership development for founders and first-time CEOs.
source: alirezarezvani/claude-skills · c-level-advisor/skills/founder-coach/SKILL.md @19392f7 · MIT
---
