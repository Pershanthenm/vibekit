...
name: board-meeting
domain: c-level
triggers: [board meeting, invokes /cs:boardroom, calls board meeting, deliberation strategic question]
description: Multi-agent board meeting protocol for strategic decisions. Runs a structured 6-phase deliberation: context loading, independent C-suite contributions (isolated, no cross-pollination), critic analysis, synthesis, founder review, and decision extraction.
source: alirezarezvani/claude-skills · c-level-advisor/skills/board-meeting/SKILL.md @19392f7 · MIT
---
