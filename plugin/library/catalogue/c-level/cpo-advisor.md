...
name: cpo-advisor
domain: c-level
triggers: [cpo advisor, setting product vision, managing product portfolio, measuring pmf, designing product teams, prioritizing portfolio level]
...
source: alirezarezvani/claude-skills · c-level-advisor/skills/cpo-advisor/SKILL.md @19392f7 · MIT
---
