...
name: challenge
domain: c-level
triggers: [challenge, significant resource commitment, before presenting board, investors, been one-sidedly positive, figure out later]
...
source: alirezarezvani/claude-skills · c-level-advisor/executive-mentor/skills/challenge/SKILL.md @19392f7 · MIT
---
