...
name: office-hours
domain: c-level
triggers: [office hours, we grow faster, route — e]
description: /cs:office-hours <topic> — YC-style 6-question founder interrogation before any advice. Forces clarity on problem, customer, distribution, defensibility, capital, and founder fit. Use when a founder question is too vague to route — e.g.
source: alirezarezvani/claude-skills · c-level-agents/skills/office-hours/SKILL.md @19392f7 · MIT
---
