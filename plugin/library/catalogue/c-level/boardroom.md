...
name: boardroom
domain: c-level
triggers: [boardroom, domains — e, /cs, critic pre-screen, synthesis, outputs board memo]
description: /cs:boardroom <brief> — 6-phase multi-role deliberation across the C-suite with Phase 2 isolation, critic pre-screen, and synthesis. Outputs a board memo. Use when a decision spans multiple executive domains — e.g.
source: alirezarezvani/claude-skills · c-level-agents/skills/boardroom/SKILL.md @19392f7 · MIT
---
