...
name: caio-review
domain: c-level
triggers: [caio review, without eval set, choosing between api, fine-tune, and self-hosted, eu ai act]
...
source: alirezarezvani/claude-skills · c-level-agents/skills/caio-review/SKILL.md @19392f7 · MIT
---
