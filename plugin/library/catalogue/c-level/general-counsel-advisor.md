...
domain: c-level
triggers: [general counsel advisor, reviewing any contract, term sheet, engage outside counsel, defining ip strategy, regulatory exposure hipaa]
...
source: alirezarezvani/claude-skills · c-level-advisor/general-counsel-advisor/skills/general-counsel-advisor/SKILL.md @19392f7 · MIT
---
