...
domain: c-level
triggers: [strategic alignment, pulling different directions, okrs dont connect, locally company expense, mentions alignment, strategy cascade]
...
source: alirezarezvani/claude-skills · c-level-advisor/skills/strategic-alignment/SKILL.md @19392f7 · MIT
---
