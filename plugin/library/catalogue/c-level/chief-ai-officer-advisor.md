...
domain: c-level
triggers: [ai officer advisor, whether call api, fine-tune, cases regulatory risk, self-hosting pays off, sequencing ai hires]
...
source: alirezarezvani/claude-skills · c-level-advisor/chief-ai-officer-advisor/skills/chief-ai-officer-advisor/SKILL.md @19392f7 · MIT
---
