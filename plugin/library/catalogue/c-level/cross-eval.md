...
name: cross-eval
domain: c-level
triggers: [cross eval, boardroom — e, /cs, memo strategy brief, cross-review graceful degradation]
description: /cs:cross-eval <memo> — Multi-model consensus on a board memo or strategy brief. Claude + Codex + Gemini cross-review with graceful degradation. Use when a high-stakes memo needs an independent sanity check before the boardroom — e.g.
source: alirezarezvani/claude-skills · c-level-agents/skills/cross-eval/SKILL.md @19392f7 · MIT
---
