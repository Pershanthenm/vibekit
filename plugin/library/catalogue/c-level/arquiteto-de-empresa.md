...
domain: c-level
triggers: [arquiteto de empresa, wants create, structure, entire company folders]
...
source: alirezarezvani/claude-skills · c-level-advisor/arquiteto-de-empresa/skills/arquiteto-de-empresa/SKILL.md @19392f7 · MIT
---
