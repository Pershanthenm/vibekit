...
domain: c-level
triggers: [decision logger, after board meeting, past decisions /cs:decisions, action items /cs:review]
...
source: alirezarezvani/claude-skills · c-level-advisor/skills/decision-logger/SKILL.md @19392f7 · MIT
---
