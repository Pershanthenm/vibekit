...
name: company-os
domain: c-level
triggers: [company os, up company operations, selecting management framework, designing meeting rhythms, building accountability systems, implementing okrs]
description: The meta-framework for how a company runs — the connective tissue between all C-suite roles. Covers operating system selection (EOS, Scaling Up, OKR-native, hybrid), accountability charts, scorecards, meeting pulse, issue resolution, and 90-day rocks.
source: alirezarezvani/claude-skills · c-level-advisor/skills/company-os/SKILL.md @19392f7 · MIT
---
