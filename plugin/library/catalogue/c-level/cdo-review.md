...
name: cdo-review
domain: c-level
triggers: [cdo review, before model work, lakehouse vs mesh, data assets productization, m&a]
...
source: alirezarezvani/claude-skills · c-level-agents/skills/cdo-review/SKILL.md @19392f7 · MIT
---
