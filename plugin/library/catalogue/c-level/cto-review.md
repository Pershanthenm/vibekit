...
name: cto-review
domain: c-level
triggers: [cto review, committing architecture, planning 10x load, rebuild against vendor]
...
source: alirezarezvani/claude-skills · c-level-agents/skills/cto-review/SKILL.md @19392f7 · MIT
---
