...
name: ma-playbook
domain: c-level
triggers: [ma playbook, evaluating acquisitions, preparing for acquisition, m&a due diligence, integration planning, deal negotiation]
...
source: alirezarezvani/claude-skills · c-level-advisor/skills/ma-playbook/SKILL.md @19392f7 · MIT
---
