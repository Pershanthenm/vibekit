...
name: cto-advisor
domain: c-level
triggers: [cto advisor, assessing technical debt, scaling engineering teams, evaluating technologies, making architecture decisions, establishing engineering metrics]
description: Technical leadership guidance for engineering teams, architecture decisions, and technology strategy.
source: alirezarezvani/claude-skills · c-level-advisor/skills/cto-advisor/SKILL.md @19392f7 · MIT
---
