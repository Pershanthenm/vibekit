...
name: freeze
domain: c-level
triggers: [freeze, pressure — e, /cs, prevent impulse reversal, primitives business layer]
description: /cs:freeze <decision> <days> — Lock a strategic decision for a cooldown period to prevent impulse reversal. Mirrors gstack's safety primitives for the business layer. Use when an irreversible decision was made under pressure — e.g.
source: alirezarezvani/claude-skills · c-level-agents/skills/freeze/SKILL.md @19392f7 · MIT
---
