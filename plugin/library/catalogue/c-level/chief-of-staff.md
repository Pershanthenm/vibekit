...
name: chief-of-staff
domain: c-level
triggers: [chief of staff, now cut burn, meetings complex decisions, synthesizes outputs, and tracks decisions, advisor — e]
description: C-suite orchestration layer. Routes founder questions to the right advisor role(s), triggers multi-role board meetings for complex decisions, synthesizes outputs, and tracks decisions. Every C-suite interaction starts here.
source: alirezarezvani/claude-skills · c-level-advisor/skills/chief-of-staff/SKILL.md @19392f7 · MIT
---
