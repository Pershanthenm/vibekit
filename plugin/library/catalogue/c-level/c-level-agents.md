...
name: c-level-agents
domain: c-level
triggers: [c level agents, virtual executive team, invoking /cs: commands, orchestrating multi-role decisions]
description: Founder-mode executive team. 13 cs-* C-suite agents (CFO, CMO, CRO, CPO, COO, CHRO, CISO, GC, CDO, CAIO, CCO, VPE, Chief of Staff) and 21 /cs:* slash commands for forcing-question office hours, multi-role boardroom deliberation, strategic sprint pipeline, and…
source: alirezarezvani/claude-skills · c-level-agents/skills/c-level-agents/SKILL.md @19392f7 · MIT
---
