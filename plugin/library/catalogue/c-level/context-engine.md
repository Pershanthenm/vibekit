...
name: context-engine
domain: c-level
triggers: [context engine, c-suite advisor session, context looks stale, missing, data external service]
...
source: alirezarezvani/claude-skills · c-level-advisor/skills/context-engine/SKILL.md @19392f7 · MIT
---
