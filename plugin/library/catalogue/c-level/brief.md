...
name: brief
domain: c-level
triggers: [brief, deliberation — e, /cs, brief office-hours intake, strategic sprint pipeline]
description: /cs:brief <topic> — Generate a one-page strategy brief from an office-hours intake. First step in the strategic sprint pipeline. Use when a strategic question needs to be framed before boardroom deliberation — e.g.
source: alirezarezvani/claude-skills · c-level-agents/skills/brief/SKILL.md @19392f7 · MIT
---
