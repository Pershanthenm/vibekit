...
name: agent-protocol
domain: c-level
triggers: [agent protocol, query each other, coordinate cross-functional analysis, meetings multiple roles]
...
source: alirezarezvani/claude-skills · c-level-advisor/skills/agent-protocol/SKILL.md @19392f7 · MIT
---
