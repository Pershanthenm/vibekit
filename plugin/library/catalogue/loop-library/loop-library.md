...
name: loop-library
domain: loop-library
triggers: [loop library, actions, verification, stopping conditions, guardrails, and handoffs]
description: Discover, find, compare, audit, repair, adapt, and design repeatable AI-agent loops with explicit triggers, actions, verification, stopping conditions, guardrails, and handoffs.
source: alirezarezvani/claude-skills · loop-library/SKILL.md @19392f7 · MIT
---
