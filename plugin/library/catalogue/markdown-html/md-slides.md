...
triggers: [md slides, classifies input slides, directly via /cs:md-slides]
description: Converts a markdown deck (slides separated by `---` HR boundaries or by `# ` H1 headings, with optional `<!-- notes: ...
source: alirezarezvani/claude-skills · markdown-html/skills/md-slides/SKILL.md @19392f7 · MIT
---
