...
Full source of the shipped skill `feature-flags`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/feature-flags.md`.
Source: alirezarezvani/claude-skills · `engineering/feature-flags-architect/skills/feature-flags-architect/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
