...
Full source of the shipped skill `api-design`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/api-design.md`.
Source: alirezarezvani/claude-skills · `engineering/skills/api-design-reviewer/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
