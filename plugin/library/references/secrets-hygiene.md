# Reference: secrets-hygiene

Full source of the shipped skill `secrets-hygiene`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/secrets-hygiene.md`.
Source: alirezarezvani/claude-skills · `engineering/skills/env-secrets-manager/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
