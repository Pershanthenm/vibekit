...
Full source of the shipped skill `incident-response`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/incident-response.md`.
Source: alirezarezvani/claude-skills · `engineering-team/skills/incident-commander/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
