...
Full source of the shipped skill `accessibility`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/accessibility.md`.
Source: alirezarezvani/claude-skills · `engineering-team/a11y-audit/skills/a11y-audit/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
