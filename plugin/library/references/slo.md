...
Full source of the shipped skill `slo`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/slo.md`.
Source: alirezarezvani/claude-skills · `engineering/slo-architect/skills/slo-architect/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
