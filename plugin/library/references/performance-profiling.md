...
Full source of the shipped skill `performance-profiling`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/performance-profiling.md`.
Source: alirezarezvani/claude-skills · `engineering/skills/performance-profiler/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
