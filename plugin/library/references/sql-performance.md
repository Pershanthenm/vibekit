# Reference: sql-performance

Full source of the shipped skill `sql-performance`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/sql-performance.md`.
Source: alirezarezvani/claude-skills · `engineering/skills/sql-database-assistant/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
