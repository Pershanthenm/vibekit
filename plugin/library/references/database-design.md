...
Full source of the shipped skill `database-design`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/database-design.md`.
Source: alirezarezvani/claude-skills · `engineering/skills/database-designer/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
