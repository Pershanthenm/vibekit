# Reference: minimal-code

Full source of the shipped skill `minimal-code`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/minimal-code.md`.
Source: alirezarezvani/claude-skills · `engineering/minimalist/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
