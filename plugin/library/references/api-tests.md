...
Full source of the shipped skill `api-tests`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/api-tests.md`.
Source: alirezarezvani/claude-skills · `engineering/skills/api-test-suite-builder/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
