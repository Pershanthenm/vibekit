...
Full source of the shipped skill `verified-apis`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/verified-apis.md`.
Source: alirezarezvani/claude-skills · `engineering/strict-api/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
