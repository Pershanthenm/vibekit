...
Full source of the shipped skill `docker`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/docker.md`.
Source: alirezarezvani/claude-skills · `engineering/docker-development/skills/docker-development/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
