...
Full source of the shipped skill `code-review`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/code-review.md`.
Source: alirezarezvani/claude-skills · `engineering-team/skills/code-reviewer/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
