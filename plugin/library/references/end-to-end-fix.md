# Reference: end-to-end-fix

Full source of the shipped skill `end-to-end-fix`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/end-to-end-fix.md`.
Source: alirezarezvani/claude-skills · `engineering/skills/focused-fix/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
