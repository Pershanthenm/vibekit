...
Full source of the shipped skill `backend-service`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/backend-service.md`.
Source: alirezarezvani/claude-skills · `engineering-team/skills/senior-backend/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
