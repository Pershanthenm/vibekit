...
Full source of the shipped skill `ci-pipeline`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/ci-pipeline.md`.
Source: alirezarezvani/claude-skills · `engineering/skills/ci-cd-pipeline-builder/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
