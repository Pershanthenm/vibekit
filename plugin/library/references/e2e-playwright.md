...
Full source of the shipped skill `e2e-playwright`, kept for depth; the skill itself is the short version in `skills/lib/vibekit/e2e-playwright.md`.
Source: alirezarezvani/claude-skills · `engineering-team/playwright-pro/skills/pw/SKILL.md` @19392f7 · MIT. Copyright (c) 2025 Alireza Rezvani. Identity phrasing was removed; nothing else was edited.
