...
4. Otherwise execute the step by invoking its skill (`vibekit playbook plan-feature`, `vibekit playbook implement-feature`, `vibekit playbook review-feature`) and let it finish.
