...
2. **Where it lives.** Options: "This folder" (recommended), "A new folder under here, named after the project", "A repository I already created on GitHub, Azure DevOps or GitLab" (they paste the URL under Other).
