...
argument-hint: "[tool ids, e.g. cursor-agent]"
...
2. If `steps` is empty, say everything is installed and continue with `vibekit playbook health`.
...
6. Finish with `vibekit playbook health`.
