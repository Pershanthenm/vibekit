...
Everything runs inside **Cursor**, with the **Claude Code extension** as your lead: a short bootstrap in Cursor's built-in terminal, then `/vibe-check-cli:setup` from the Claude panel does the rest.
...
Both end in the same place: `/vibe-check-cli:health live` all green.
