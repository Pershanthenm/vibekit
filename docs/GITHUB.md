...
`.github/workflows/tests.yml` is already in the kit. On every pull request and every push to `main`, it runs the 313 integration tests and Claude Code's own plugin validator. If you use the ruleset above, pick the **tests** check as required.
